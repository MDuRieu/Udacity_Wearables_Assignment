...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        //Populate this array with data for the wearable and then send it to prevent
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                //Add the values to pass to the wearable
                ...
                //WeatherId is for the icon type
    ...
    //Method stub from Udacity student Antonio Bust
    ...
    //These three connection methods are declared outside the initialisation of the client
    //because otherwise the IDE throws a required methods error
    @Override
    public void onConnected(Bundle connectionHint) {
        Log.d(WEARABLE_TAG, "onConnected: " + connectionHint);
        sendDataToWearables();

    }
    @Override
    public void onConnectionSuspended(int cause) {
        Log.d(WEARABLE_TAG, "onConnectionSuspended: " + cause);
    }
